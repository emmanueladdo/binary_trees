...
/**
 * levelordering - binary tree level ordering recursive help function
...
/**
 * new_binary_tree_height - Measure height of a binary tree from given node
...
int new_binary_tree_height(const binary_tree_t *tree)
{
	...
	left = new_binary_tree_height(tree->left) + 1;
	right = new_binary_tree_height(tree->right) + 1;
...
void binary_tree_levelorder(const binary_tree_t *tree, void (*func)(int))
{
	...
	height = new_binary_tree_height(tree);
